...
public class ProximityService extends Service {
    ...
    public void onDestroy() {
        ...
        if (mBtAdapter != null && mBluetoothGatt != null) {
        	...
        	//Log.d(Globals.TAG, "Closing Gatt Profile1");
        }
        if (mBtAdapter != null && mBluetoothGattServer != null) {
        	//Log.d(Globals.TAG, "Closing Gatt Profile2");
    ...
    private BluetoothGattCallback mGattCallbacks = new BluetoothGattCallback() {
        ...
        public void onScanResult(BluetoothDevice device, int rssi, byte[] scanRecord) {
            ...
            if (!checkIfBroadcastMode(scanRecord)) {
                ...
                Message msg = Message.obtain(mDeviceListHandler, BLEScanHandler.BLE_DEVICE_FOUND_MESSAGE);
    ...
    public boolean isBLEDevice(BluetoothDevice device) {
        boolean result = false;
        Log.d("BlePxpMonitor", "Check mBluetoothGatt: "+mBluetoothGatt);
